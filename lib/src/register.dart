  ...
  void _loadSettings() async {
    ...
    this.setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'wss://sip.levlet.io:8089/ws';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? 'User2@sip.levlet.io';
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'User 2';
